#!/usr/bin/env python3
"""Prepare RegMix 10B memmap path lists for plain-CE control training.
...
def main() -> int:
    ...
    ap.add_argument(
        ...
        help="Training token budget (default: measured RegMix 10B)",
    )
    args = ap.parse_args()
    ...
    (work / "regmix_data_summary.json").write_text(json.dumps(summary, indent=2) + "\n")
