...
sed -i 's/\r$//' "${REPO}/datasets/fineweb/"*.py "${REPO}/datasets/fineweb/"*.sh "${REPO}/datasets/fineweb/"*.sbatch || true
...
sbatch --exclude=wheat-01 \
  --export=ALL,RUN_DIR='${RUN_DIR}',STAGE_DIR='${RUN_DIR}/publish-stage',EDULLM_ROOT='${EDULLM_ROOT}',AWS_SESSION_ENV='${RUN_DIR}/aws-session.env',HF_FINEWEB_EDU_REVISION='87f09149ef4734204d70ed1d046ddc9ca3f2b8f9' \
  '${EDULLM_ROOT}/datasets/fineweb/publish_fineweb_edu_1b_combined.sbatch'
EOF
