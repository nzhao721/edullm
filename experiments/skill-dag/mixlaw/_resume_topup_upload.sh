#!/usr/bin/env bash
# Resume olmohq topup upload with skip-if-exists finalize + fresh login-minted creds.
set -Eeuo pipefail
...
# Longer wall time; resume skips already-uploaded objects.
