...
| Steps | ~2384 (10B tokens) |
| Permanent ckpts | `{0, 125, …, 2250, 2384}` (omit 2375); `max_checkpoints=None`; no ephemeral |
...
`FrozenReference` refuses remote `s3://` URIs. Export a local flat `model.pt` first:
