...
# α ≈ 0.9985 for ~20% of a 2384-step run:
assert abs(alpha_for_half_life(0.2 * 2384) - 0.9985) < 5e-5
...
export RUN_DIR=/path/to/scratch/rel-ema-refhq-run
