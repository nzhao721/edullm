...
- **Token budget:** one epoch of published `pretrain/regmix-10b` train (~9.989B catalog); YAML/standalone defaults use `9900000000` → **2360** steps at GBS `4_194_304` (no forced 10B wrap).
